...
public class ProductController {
    ...
    public Product updateCurrentAmountAdmin(@PathVariable Long productId, @RequestBody Map<String, Integer> payload) {
        return productService.updateCurrentAmountAdmin(productId, payload.get("amount"));
    }
